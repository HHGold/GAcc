...
source_image_path = r"c:\AI\GAcc\icon_zoomed_exact.png"
...
try:
    with Image.open(source_image_path) as img:
        ...
        # It's already square, but let's double check
        ...
        for density, size in sizes.items():
            ...
            print(f"Generated {density} zoomed icons.")
    print("Zoomed icons successfully processed!")
